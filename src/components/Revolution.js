    ...
    return (
        <Grid container direction="column">
            ...
            <Grid item container direction={matchesMD ? "column" : "row"} alignItems="center"
                  className={classes.rowContainer} style={{marginTop: "5em"}}>
                <Grid item lg>
                    <img
                        src={vision}
                ...
                <Grid item container direction="column" lg style={{maxWidth: "40em"}}>
                    ...
                    <Grid item>
                        ...
                        <Typography align={matchesMD ? "center" : "right"} variant="body1" paragraph>
                            ...
                            lives is at the heart of everything
                            we do.
                        </Typography>
                        <Typography align={matchesMD ? "center" : "right"} variant="body1" paragraph>
                            ...
                            this next chapter of technological
            ...
            <Grid item container direction={matchesMD ? "column" : "row"} alignItems="center"
                  className={classes.rowContainer} style={{marginTop: "10em", marginBottom: "10em"}}>
                <Grid item container direction="column" lg style={{maxWidth: "40em"}}>
                    <Grid item>
                    ...
                    <Grid item>
                        ...
                        <Typography align={matchesMD ? "center" : undefined} variant="body1" paragraph>
                            ...
                            faster, easier to maintain, and are easily reused
                            and customized, each serving a singular purpose.
                        </Typography>
                        <Typography align={matchesMD ? "center" : undefined} variant="body1" paragraph>
                            ...
                            development platforms, you can leverage the
                            knowledge you already possessed from building websites and reapply it directly! This was a
                            huge leap forward.
                        </Typography>
                        <Typography align={matchesMD ? "center" : undefined} variant="body1" paragraph>
                        ...
                        <Typography align={matchesMD ? "center" : undefined} variant="body1" paragraph>
                            ...
                            barrier to entry for mobile app
                            development.
                        </Typography>
                        <Typography align={matchesMD ? "center" : undefined} variant="body1" paragraph>
                ...
                <Grid item container direction="column" alignItems={matchesMD ? "center" : undefined} lg>
                    ...
                    <Grid item>
                        <Typography align={matchesMD ? "center" : undefined} variant="body1"
                                    style={{color: "#fff", maxWidth: "20em"}} paragraph>
                            ...
                            want to step things up, our initial
                        ...
                        <Typography align={matchesMD ? "center" : undefined} variant="body1"
                            ...
                            intuition will help usher you into this new
                ...
                <Grid item container direction="column" alignItems={matchesMD ? "center" : undefined} lg>
                    ...
                    <Grid item>
                        ...
                        <Typography variant="body1" align={matchesMD ? "center" : undefined}
                            ...
                            a mockup, which doesn’t include colors, images, or any other polished design elements, but
                            captures the essential layout
                ...
                <Grid item container direction="column" alignItems={matchesMD ? "center" : undefined} lg>
                    ...
                    <Grid item>
                        <Typography variant="body1" align={matchesMD ? "center" : undefined}
                            ...
                            to discuss any changes you may want or any ideas you may have come up with before any heavy
                ...
                <Grid item container direction="column" alignItems={matchesMD ? "center" : undefined} lg>
                    ...
                    <Grid item>
                        <Typography variant="body1" align={matchesMD ? "center" : undefined}
                            ...
                            fonts, colors, and logos to extend
                            the experience you’re already familiar with.
                        </Typography>
                        <Typography variant="body1" align={matchesMD ? "center" : undefined}
                                    style={{color: "#fff", maxWidth: "20em"}} paragraph>
            ...
            <Grid item container direction={matchesMD ? "column" : "row"} className={classes.rowContainer}
                ...
                <Grid item container direction="column" alignItems={matchesMD ? "center" : undefined} lg>
                    ...
                    <Grid item>
                        <Typography variant="body1" align={matchesMD ? "center" : undefined}
                                    style={{color: "#fff", maxWidth: "20em"}} paragraph>
                            A second round of review is essential to our goal of creating exactly what you want, exactly
                            how you want it.
                        </Typography>
                        <Typography variant="body1" align={matchesMD ? "center" : undefined}
                                    style={{color: "#fff", maxWidth: "20em"}} paragraph>
                            This time we’ll be going over the finalized designs in another fully interactive
                            demonstration. Again this gives you an opportunity to tweak things and make sure we get
            ...
            <Grid item container direction={matchesMD ? "column" : "row"} className={classes.rowContainer}
                ...
                <Grid item container direction="column" alignItems={matchesMD ? "center" : undefined} lg>
                    ...
                    <Grid item>
                        ...
                        <Typography variant="body1" align={matchesMD ? "center" : undefined}
                                    style={{color: "#fff", maxWidth: "20em"}} paragraph>
                            Each area is then developed in order of importance until ready to be connected to the next
                            piece.
                        </Typography>
                        <Typography variant="body1" align={matchesMD ? "center" : undefined}
                                    style={{color: "#fff", maxWidth: "20em"}} paragraph>
                ...
                <Grid item container direction="column" alignItems={matchesMD ? "center" : undefined} lg>
                    ...
                    <Grid item>
                        ...
                        <Typography variant="body1" align={matchesMD ? "center" : undefined}
                            ...
                            demonstration to show off your shiny new software in the wild so you know exactly how it
            ...
            <Grid item container direction={matchesMD ? "column" : "row"} className={classes.rowContainer}
                ...
                <Grid item container direction="column" alignItems={matchesMD ? "center" : undefined} lg>
                    ...
                    <Grid item>
                        ...
                        <Typography variant="body1" align={matchesMD ? "center" : undefined}
                                    style={{color: "#fff", maxWidth: "20em"}} paragraph>
                            From there on out we make sure your application is kept up to date and taking advantage of
                            the best features and practices available. When new developments arise or new techniques are
                            discovered in future projects, we
            ...
            <Grid item container direction={matchesMD ? "column" : "row"} justify={matchesMD ? "center" : undefined}
                  className={classes.rowContainer} style={{backgroundColor: "#29ABE2", height: "90em"}}>
                <Grid item container direction="column" alignItems={matchesMD ? "center" : undefined} lg>
                    <Grid item>
                        <Typography variant="h4" align={matchesMD ? "center" : undefined} gutterBottom
                                    style={{color: "#000", marginTop: matchesMD ? 0 : "5em"}}>
                    ...
                    <Grid item>
                        ...
                        <Typography variant="body1" align={matchesMD ? "center" : undefined}
                                    style={{color: "#fff", maxWidth: "20em"}} paragraph>
                            By planning for future features and changes we can build and evolve your application over
                            time. As new use cases and customer needs develop we can respond with continuous integration
                            of new content.
                        </Typography>
                        <Typography variant="body1" align={matchesMD ? "center" : undefined}
                                    style={{color: "#fff", maxWidth: "20em"}} paragraph>
